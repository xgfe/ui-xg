...
(function () {
  ...
  angular.module('ui.xg.form', []).controller('uixFormCtrl', ['$scope', '$compile', '$templateCache', '$element', '$q', '$timeout', function ($scope, $compile, $templateCache, $element, $q, $timeout) {
    ...
    $form.html = '';
    $form.tplObj = {}; // colClass

    $form.getColClass = function (item) {
      var name = '';

      if (item.colWidth && $form.layout !== 'horizontal') {
        name += " col-md-".concat(item.colWidth);
      }
    ...
    $form.getLabelClass = function (item) {
      var name = '';
      ...
      if (item.labelWidth && $form.layout !== 'inline') {
        name += " col-md-".concat(item.labelWidth);
      }
    ...
    $form.getElementClass = function (item) {
      var name = 'uix-form-pos-rlt';
      ...
      if (item.elementWidth && $form.layout !== 'inline') {
        name += " col-md-".concat(item.elementWidth);
      }
